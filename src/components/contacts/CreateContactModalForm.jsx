        ...
        <form onSubmit={handleSubmit}>
              ...
              <TextField
                ...
                sx={{
                  '& .MuiOutlinedInput-root': {
                    ...
                    '&.Mui-focused fieldset': { borderColor: 'primary.main', boxShadow: '0 0 0 2px rgba(25, 118, 210, 0.1)' },
                  },
                }}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              ...
              >
                ...
                >
                  ...
                  <MenuItem value="Opportunity">Former Client</MenuItem>
          ...
          {error && (
            <Typography
              color="error.main"
              variant="body2"
              sx={{ mt: 2, fontWeight: '500', backgroundColor: 'error.50', p: 1, borderRadius: '4px' }}
            >
              {error}
            </Typography>
          )}
          ...
          <Box sx={{ mt: 4, display: 'flex', justifyContent: 'flex-end', gap: 2 }}>
            ...
            <Button
              ...
              sx={{
                ...
                '&:disabled': { backgroundColor: 'grey.300', color: 'grey.600' },
              }}
            >
