...
const JobEditModal = ({ open, onClose, job, onUpdate }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Notify parent to update state (for backward compatibility)
      if (onUpdate) {
      ...
      >
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helperText={
                  errors.invoiceUrl || "Optional: URL to invoice document"
                }
                ...
                sx={{
                  ...
                  "& .MuiFormHelperText-root": {
                    color: errors.invoiceUrl ? "#dc2626" : "#6b7280",
                    fontSize: "0.8rem",
                  },
                }}
              />
        ...
        {activeTab === 1 && (
          ...
          >
            ...
            >
              Client information is read-only. To change the client, create a
              new job.
            </Typography>
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <TextField
                  label="Client Name"
                  value={getClientFieldValue("name", "No client name provided")}
                  disabled
                  fullWidth
                  sx={{
                    "& .MuiOutlinedInput-root": {
                    ...
                    "& .MuiInputBase-input.Mui-disabled": {
                      color: formData.client?.name ? "#374151" : "#9ca3af",
                      WebkitTextFillColor: formData.client?.name
                        ? "#374151"
                        : "#9ca3af",
                    },
                  }}
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  sx={{
                    ...
                    "& .MuiInputBase-input.Mui-disabled": {
                      color: formData.client?.email ? "#374151" : "#9ca3af",
                      WebkitTextFillColor: formData.client?.email
                        ? "#374151"
                        : "#9ca3af",
                    },
                  }}
                  ...
                  sx={{
                    ...
                    "& .MuiInputBase-input.Mui-disabled": {
                      color: formData.client?.phoneNumber
                        ? "#374151"
                        : "#9ca3af",
                      WebkitTextFillColor: formData.client?.phoneNumber
                        ? "#374151"
                        : "#9ca3af",
                    },
                  }}
